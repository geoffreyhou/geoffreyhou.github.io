...
## 联合高斯假设下的线性贝叶斯估计量
### 多为高斯条件PDF
如果$\boldsymbol{x_{k \times 1}}$和$\boldsymbol{y_{k \times 1}}$是联合高斯的，均值矢量是$\left[\begin{array}{ll}E[\boldsymbol{x}]^{\mathrm{T}} & \left.E[\boldsymbol{y}]^{\mathrm{T}}\right]^{\mathrm{T}}\end{array}\right.$，协方差是
