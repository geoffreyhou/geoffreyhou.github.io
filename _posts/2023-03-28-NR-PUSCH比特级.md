...
[码块分割.pdf](https://github.com/geoffreyhou/geoffreyhou.github.io/files/11169373/default.pdf)
...
表示集合$\left|\Phi_l^{\mathrm{UL}-\mathrm{SCH}}\right|$中的元素个数，$\Phi_l^{\mathrm{UL}-\mathrm{SCH}}(j)$表示第$j$个元素。
